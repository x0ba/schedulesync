...
export default function Home() {
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-orange-50/40 via-background to-background pt-16">
        {/* Decorative background elements */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 right-1/4 size-96 rounded-full bg-gradient-to-br from-amber-200/30 to-orange-200/20 blur-3xl" />
          <div className="absolute top-1/3 -left-32 size-80 rounded-full bg-gradient-to-br from-orange-100/40 to-amber-100/30 blur-3xl" />
        </div>
